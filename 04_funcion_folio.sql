...
-- ------------------------------------------------------------
-- Segun campos esto es para llamar comom a la funcion o bueno si asi venia en su examen de lab que me dio duro 
...
-- ------------------------------------------------------------
-- VERIFICACION: probar la funcion
-- Ejecutar para ver que genera folios correctamente
-- ------------------------------------------------------------
-- SELECT generar_folio();  -- Retorna: ORD-001
-- SELECT generar_folio();  -- Retorna: ORD-002
-- SELECT generar_folio();  -- Retorna: ORD-003
