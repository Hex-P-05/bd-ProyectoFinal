...
-- PostgreSQL
-- Parris revisa si asi esta bien 
-- los mascapos
-- ============================================================
-- 
-- Se utiliza la estrategia "tabla por subclase" (table per subclass),
-- donde cada subtipo (COCINERO, MESERO, ADMINISTRATIVO) tiene su
-- propia tabla con FK al empleado padre. Esto permite que un empleado
-- pueda tener multiples roles simultaneamente (especializacion solapada)
-- sin redundancia de datos, y facilita la integridad referencial.
-- ============================================================



--LIMPIEZA: DROP en orden inverso para respetar FK
...
-- VERIFICACION: mostrar tablas creadas para ver que todo jale bien 
SELECT table_name
FROM information_schema.tables
WHERE table_schema = 'public'
ORDER BY table_name;

--- Esto es como opcinal ppaus revisenlo jaja
